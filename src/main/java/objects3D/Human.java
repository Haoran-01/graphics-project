...
public class Human {
	...
	public void drawHuman(float delta, boolean GoodAnimation, Texture head, Texture body, boolean buyIceCream) {
		float theta = (float) (delta * 2 * Math.PI);
		float LimbRotation;
		if (GoodAnimation) {
			LimbRotation = (float) Math.cos(theta * 4) * 45;
		} else {
			LimbRotation = 0;
		}
			...
			glPushMatrix();
			{
				...
				glPushMatrix();
				{
					...
					glPushMatrix();
					{
						...
						glPushMatrix();
						{
							...
							cylinder.drawCylinder(1f,0.1f, 32);
							...
							glPushMatrix();
							{
								...
								glRotatef(LimbRotation, 0.0f, 0.0f, 1.0f);
								glColor3f(cyan[0], cyan[1], cyan[2]);
								cylinder.drawCylinder(0.45f,0.55f, 32);
				...
				glPushMatrix();
				{
					...
					glPushMatrix();
					{
						...
						// glRotatef(90.0f,1.0f,0.0f,0.0f);
						cylinder.drawCylinder(0.2f, 0.7f, 32);
						...
						glPushMatrix();
						{
							...
							glPushMatrix();
							{
								...
								glPushMatrix();
								{
									...
									{
										glRotatef(90, 1.0f, 0.0f, 0.0f);
										cylinder.drawCylinder(0.25f, 0.6f, 32);
									}
									glPopMatrix();
...
//
	...
	public void drawIceCreamHuman(float delta, boolean GoodAnimation, Texture head, Texture body) {
		float theta = (float) (delta * 2 * Math.PI);
		float LimbRotation;
		if (GoodAnimation) {
...
//							glRotatef(LimbRotation, -1.0f, 0.0f, 0.0f);
				...
				glPushMatrix();
				{
					...
					glColor3f(black[0], black[1], black[2]);
					glRotatef(90, 1.0f, 0.0f, 0.0f);
					cylinder.drawCylinder(1f, 0.1f, 15);
				}
				glPopMatrix();
				// pelvis
...
//
	...
	public void drawDrawHuman(float delta, boolean GoodAnimation, Texture head, Texture body, Texture hat) {
		float theta = (float) (delta * 2 * Math.PI);
		float LimbRotation;
		if (GoodAnimation) {
			LimbRotation = (float) Math.cos(theta) * 45;
								...
								glPushMatrix();
								{
									...
									glPushMatrix();
									{
										...
										glPushMatrix();
										{
											...
											cylinder.drawCylinder(0.05f,1.0f,10);
										}
										glPopMatrix();
									}
									glPopMatrix();
								...
								glPushMatrix();
								{
									...
									glPushMatrix();
									{
...

										{
											...
											glRotatef(-90, 1.0f, 0.0f, 0.0f);
											glColor3f(orange[1], orange[2], orange[3]);
											cylinder.drawCylinder(0.6f, 0.1f, 10);
										}
...
//
	...
	public void drawSitDownHuman(float delta, boolean GoodAnimation, Texture head, Texture body) {
		float theta = (float) (delta * 2 * Math.PI);
		float LimbRotation;
		if (GoodAnimation) {
			LimbRotation = (float) Math.cos(theta) * 45;
...
//
	...
	public void drawCorsairHuman(float delta, Texture head, Texture body) {

		float theta = (float) (delta * 2 * Math.PI);
		float LimbRotation = (float) Math.cos(2 * theta) * 45;
		Sphere sphere = new Sphere();
		Cylinder cylinder = new Cylinder();
		IceCream iceCream = new IceCream();
				...
				glPushMatrix();
				{
					...
					glPushMatrix();
					{
						...
						glPushMatrix();
						{
							...
							glRotatef(90.0f, 1.0f, 0.0f, 0.0f);
							glRotatef(60, 0,1,0);
							glRotatef(LimbRotation + 30,0,1,0);
							cylinder.drawCylinder(0.15f, 0.7f, 10);
...
//
	...
	public void drawWhirligigHuman(float delta, Texture head, Texture body) {
